<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $role = in_array($_POST['role'] ?? 'farmer', ['farmer', 'guest'], true) ? $_POST['role'] : 'farmer';
        ...
        try {
            ...
            if ($result_statement->num_rows > 0) {
                echo "<script> alert('Contact Information Unavailable'); </script>";
            }
            else {
                $query_statement = $connection->prepare("INSERT INTO myUsers (firstName, lastName, middleName, address, email, contactNo, sex, birthDate, password, role, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'offline')");
                $query_statement->bind_param("ssssssssss", $firstName, $lastName, $middleName, $address, $email, $contactNo, $sex, $birthDate, $hash, $role);
    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        ...
        <main class="form-signin w-100 m-auto">
            <form action="sign-up.php" method="post" onsubmit="return validateForm()">
                ...
                <h1 class="h3 mb-3 fw-normal center-header">Sign Up</h1>
                ...
                <div class="form-floating">
                    <input type="text" name="contactNo" class="form-control" id="floatingInput" placeholder="Phone No.">
                    <label for="floatingInput">Phone No.</label>
                </div>
                <div class="mb-1 align-items-center gap-3 sex-row">
                    <label class="form-label mb-0 fw-semibold form-control">Sex :</label>
                ...
                <div class="form-floating">
                    ...
                    <label for="floatingRole">Account type</label>
                </div>
                ...
                <a href="sign-in.php" class="center-header">Sign In?</a>
            </form> 
        </main>
